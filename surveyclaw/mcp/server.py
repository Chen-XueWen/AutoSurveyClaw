"""SurveyClaw MCP Server: expose pipeline capabilities to external agents."""
...
from surveyclaw.mcp.tools import TOOL_DEFINITIONS, list_tool_names

logger = logging.getLogger(__name__)


class SurveyClawMCPServer:
    """MCP Server that exposes AutoSurveyClaw capabilities as tools.
