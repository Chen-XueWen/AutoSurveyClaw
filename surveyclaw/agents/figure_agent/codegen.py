...
from surveyclaw.agents.base import BaseAgent, AgentStepResult
from surveyclaw.agents.figure_agent.style_config import get_style_preamble
from surveyclaw.utils.sanitize import sanitize_figure_id
...
class CodeGenAgent(BaseAgent):
    ...
    def _generate_script(
        ...
        *,
        ...
        from surveyclaw.agents.figure_agent.style_config import FIGURE_WIDTH, DEFAULT_FIGURE_HEIGHT
