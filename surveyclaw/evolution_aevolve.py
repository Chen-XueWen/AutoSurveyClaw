...
if TYPE_CHECKING:
    from surveyclaw.evolution import LessonEntry
...
_OBSERVE_SYSTEM = """\
You are a pipeline diagnostician for AutoSurveyClaw, a 23-stage autonomous
...
_EVOLVE_SYSTEM = """\
You are a skill designer for AutoSurveyClaw. Based on diagnostic
