...
The newer domain system in :mod:`surveyclaw.domains.detector` is more
...
from surveyclaw.domains.detector import DomainProfile, detect_domain as _detect_profile
