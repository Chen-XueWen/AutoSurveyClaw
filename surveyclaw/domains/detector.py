...
class DomainProfile:
    ...
    Loaded from YAML files in ``surveyclaw/domains/profiles/``.
    """
    ...
    docker_image: str = "surveyclaw/sandbox-generic:latest"
...
def _load_profile(path: Path) -> DomainProfile:
    ...
    return DomainProfile(
        ...
        docker_image=data.get("docker_image", "surveyclaw/sandbox-generic:latest"),
...
def get_generic_profile() -> DomainProfile:
    ...
    return DomainProfile(
        ...
        docker_image="surveyclaw/sandbox-generic:latest",
    )
