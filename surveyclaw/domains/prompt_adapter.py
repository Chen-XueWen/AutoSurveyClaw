...
from surveyclaw.domains.detector import DomainProfile, is_ml_domain
...
def _build_adapter_registry() -> dict[str, type[PromptAdapter]]:
    ...
    try:
        ...
        pass
    try:
        from surveyclaw.domains.adapters.security import SecurityPromptAdapter
        registry["security_"] = SecurityPromptAdapter
    except ImportError:
        pass
    try:
        from surveyclaw.domains.adapters.math import MathPromptAdapter
