"""Tests for surveyclaw.web.scholar — GoogleScholarClient."""
...
from surveyclaw.web.scholar import GoogleScholarClient, ScholarPaper
...
class TestGoogleScholarClient:
    @patch("surveyclaw.web.scholar.HAS_SCHOLARLY", True)
