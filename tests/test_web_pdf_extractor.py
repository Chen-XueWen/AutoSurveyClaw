"""Tests for surveyclaw.web.pdf_extractor — PDFExtractor."""
...
from surveyclaw.web.pdf_extractor import PDFContent, PDFExtractor
...
"""
    ...
    @patch("surveyclaw.web.pdf_extractor.urlopen")
