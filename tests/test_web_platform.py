...
class TestServerConfig:
    ...
    def test_server_config_defaults(self) -> None:
        from surveyclaw.config import ServerConfig
    ...
    def test_dashboard_config_defaults(self) -> None:
        from surveyclaw.config import DashboardConfig
    ...
    def test_parse_server_config(self) -> None:
        from surveyclaw.config import _parse_server_config
    ...
    def test_parse_dashboard_config(self) -> None:
        from surveyclaw.config import _parse_dashboard_config
    ...
    def test_rcconfig_has_server_and_dashboard(self) -> None:
        from surveyclaw.config import RCConfig, ServerConfig, DashboardConfig
...
class TestIntents:
    ...
    def test_help_intent(self) -> None:
        from surveyclaw.server.dialog.intents import Intent, classify_intent
...
class TestSession:
    ...
    def test_session_create(self) -> None:
        from surveyclaw.server.dialog.session import SessionManager
    ...
    def test_session_max_history(self) -> None:
        from surveyclaw.server.dialog.session import ChatSession
...
class TestDashboardCollector:
    ...
    def test_collect_empty_dir(self) -> None:
        from surveyclaw.dashboard.collector import DashboardCollector
    ...
    def test_snapshot_to_dict(self) -> None:
        from surveyclaw.dashboard.collector import RunSnapshot
...
class TestMetrics:
    ...
    def test_aggregate_empty(self) -> None:
        from surveyclaw.dashboard.metrics import aggregate_metrics
    ...
    def test_extract_training_curve(self) -> None:
        from surveyclaw.dashboard.metrics import extract_training_curve
...
class TestVoiceCommands:
    ...
    def test_start_command(self) -> None:
        from surveyclaw.voice.commands import VoiceCommand, parse_voice_input
...
class TestWizard:
    ...
    def test_list_templates(self) -> None:
        from surveyclaw.wizard.templates import list_templates
    ...
    def test_get_template(self) -> None:
        from surveyclaw.wizard.templates import get_template
    ...
    def test_wizard_web_mode(self) -> None:
        from surveyclaw.wizard.quickstart import QuickStartWizard
    ...
    def test_environment_detection(self) -> None:
        from surveyclaw.wizard.validator import detect_environment
...
class TestEvents:
    ...
    def test_event_serialization(self) -> None:
        from surveyclaw.server.websocket.events import Event, EventType
    ...
    def test_event_types_enum(self) -> None:
        from surveyclaw.server.websocket.events import EventType
...
class TestDialogRouter:
    ...
    async def test_route_help_message(self) -> None:
        from surveyclaw.server.dialog.router import route_message
...
class TestFastAPIApp:
    ...
    def app(self, _skip_if_no_fastapi: None) -> object:
        ...
        from surveyclaw.server.app import create_app
