...
from surveyclaw.llm import PROVIDER_PRESETS, create_llm_client
from surveyclaw.llm.client import LLMClient, LLMConfig, LLMResponse
...
class TestMiniMaxCLI:
    ...
    def test_minimax_in_provider_choices(self):
        from surveyclaw.cli import _PROVIDER_CHOICES
...
class TestMiniMaxFactory:
    ...
    def test_create_llm_client_returns_llm_client(self):
        from surveyclaw.config import LlmConfig, RCConfig
