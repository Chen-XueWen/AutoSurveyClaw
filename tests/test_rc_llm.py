...
from surveyclaw.llm.client import (
    LLMClient,
    LLMConfig,
    LLMResponse,
    _NEW_PARAM_MODELS,
...
def test_acp_large_prompt_uses_file_transport_before_cli_limit():
    from surveyclaw.llm.acp_client import ACPClient, ACPConfig
...
def test_acp_windows_cmd_wrapper_uses_lower_inline_limit(monkeypatch: pytest.MonkeyPatch):
    from surveyclaw.llm.acp_client import ACPClient

    monkeypatch.setattr("surveyclaw.llm.acp_client.sys.platform", "win32")
