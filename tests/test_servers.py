...
from surveyclaw.servers.registry import ServerEntry, ServerRegistry
from surveyclaw.servers.monitor import ServerMonitor, _parse_status_output
from surveyclaw.servers.dispatcher import TaskDispatcher
from surveyclaw.servers.ssh_executor import SSHExecutor
from surveyclaw.servers.slurm_executor import SlurmExecutor
from surveyclaw.servers.cloud_executor import CloudExecutor
...
class TestServerMonitor:
    ...
    def test_check_status_unreachable(self, registry: ServerRegistry) -> None:
        monitor = ServerMonitor(registry)
        with patch("surveyclaw.servers.monitor._ssh_command", side_effect=RuntimeError("unreachable")):
