"""Integration tests for surveyclaw.web — WebSearchAgent end-to-end."""
...
from surveyclaw.web.agent import WebSearchAgent, WebSearchAgentResult
from surveyclaw.web.crawler import CrawlResult
from surveyclaw.web.search import SearchResult, WebSearchResponse
from surveyclaw.web.scholar import ScholarPaper
...
class TestWebSearchAgent:
    ...
    @patch("surveyclaw.web.search.urlopen")
    @patch("surveyclaw.web.scholar.scholarly")
    ...
    @patch("surveyclaw.web.search.urlopen")
    @patch("surveyclaw.web.scholar.scholarly")
    @patch("surveyclaw.web.crawler.urlopen")
...
class TestWebSearchConfig:
    def test_default_config(self):
        from surveyclaw.config import WebSearchConfig
        cfg = WebSearchConfig()
