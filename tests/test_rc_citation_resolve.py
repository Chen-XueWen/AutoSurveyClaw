...
# does `from surveyclaw.literature.search import search_papers`, so we patch
# the source module.
_SEARCH_PAPERS_PATH = "surveyclaw.literature.search.search_papers"
...
class TestLoadSeminalPapersByKey:
    ...
    def test_loads_well_known_keys(self):
        from surveyclaw.pipeline.stage_impls._review_publish import (
...
class TestSeminalToBibtex:
    ...
    def test_conference_paper(self):
        from surveyclaw.pipeline.stage_impls._review_publish import _seminal_to_bibtex
        entry = {
