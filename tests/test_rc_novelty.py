"""Tests for surveyclaw.literature.novelty — novelty detection module."""
...
from surveyclaw.literature.novelty import (
    _assess_novelty,
...
class TestCheckNovelty:
    ...
    @patch("surveyclaw.literature.search.search_papers_multi_query")
...
class TestHypothesisGenNoveltyIntegration:
    ...
    def test_novelty_report_written_when_available(self, tmp_path: Path) -> None:
        ...
        from surveyclaw.pipeline.executor import _execute_hypothesis_gen
        ...
        with patch(
            "surveyclaw.literature.search.search_papers_multi_query"
        ) as mock_search:
            mock_search.return_value = []
    ...
    def test_novelty_failure_does_not_block(self, tmp_path: Path) -> None:
        ...
        with patch(
            "surveyclaw.literature.novelty.check_novelty",
